			...
			<div class="col s12 m8">
				<div class="card">
					...
					<div class="card-action">
						<h5 style="text-align: left">Keycode Request</h5>
						<p>Hi {{ $locksmith->firstname }},</p>
						<p style="text-align: justify">You keycode request has been {{ $status }}.<br>
						<br>
						The result for the {{ $transaction->make }} is as follows:
						</p>
						<span>
							<p>Results</p>
							<h4>{{ $remarks }}</h4>
